    ...
    <section id="services" class="services section">
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          @foreach($formation as $chapitres)
            <div class="col-lg-4 col-md-6 product_data " data-aos="fade-up" data-aos-delay="100">
                <div class="service-item  position-relative">
                  <div class="image">
                    <img src="{{ asset('assets/uploads/chapitre_images/'.$chapitres->image_url) }}" class="img-fluid rounded-4" alt="">
                  </div>
                  {{--  <a href="#" class="stretched-link">  --}}
                    <h3 class="text-center">{{$chapitres->titre}}</h3>
                  {{--  </a>  --}}
                  ...
                  <button  class="btn btn-success addToCartBtn  float-end">Ajouter au panier</button>  --}}
                    <a href="{{url('quiz/'.$chapitres->id)}}" target="blank" class="btn btn-success">Faire un quiz</a>
                    <a href="{{asset('assets/uploads/chapitre_documents/'.$chapitres->document_url)}}" target="blank" class="btn btn-primary float-end">Télécharger le module</a>
                </div>
              </div>
