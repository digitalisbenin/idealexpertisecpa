      ...
      <div class="container d-lg-flex justify-content-between align-items-center">
        ...
        <nav class="breadcrumbs">
          <ol>
            ...
            <li class="current">Paiement en cours de validation</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
      ...
      <div class="container">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-xl-9 text-center text-xl-start">
            <h3>Votre paiement est en cours de validation</h3>
            <p></p>
          </div>
          <div class="col-xl-3 cta-btn-container text-center">
            @php
    $idTransaction = request()->query('id_transaction');
@endphp



{{--  <a class="cta-btn align-middle" href="contact">Prendre Rendez-Vous</a>  --}}
            <form action="{{ url('mes-cours') }}" method="POST">
                @csrf
                <input type="hidden" name="id_transaction" value=" {{ request()->query('id_transaction'); }}">
                <button type="submit" class="cta-btn align-middle" >cliquez ici pour voir mes cours</button>
            </form>
