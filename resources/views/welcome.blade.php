...
<body class="index-page">
          ...
          <ul>
           ...
           <li class="dropdown"><a href="#"><span>{{ Auth::user()->name }}</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="{{url('user-resultes#resultats')}}"> MES RESULTATS</a></li>
              <li><a href="{{ url('/mes-cours') }}">MES FORMATIONS</a></li>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active">
          <img src="assets/img/hero-carousel/carousel1.jpeg" alt="">
          <div class="container">
            <h2>IDEALEXPERTISE CPA</h2>
            <p>Vous accompagne dans le développement de votre entreprise.</p>
            <a href="service" class="btn-get-started">Nos Services</a>
          </div>
        </div><!-- End Carousel Item -->

        <div class="carousel-item">
          <img src="assets/img/hero-carousel/carousel2.jpeg" alt="">
          <div class="container">
            <h2>Une grande expérience</h2>
            <p>Résultant de la somme des expériences de nos Experts</p>
            <a href="galerie" class="btn-get-started">Notre Equipe</a>
          </div>
        </div><!-- End Carousel Item -->

        <div class="carousel-item">
          <img src="assets/img/hero-carousel/carousel3.jpg" alt="">
          <div class="container">
            <h2>Nous vous conseillons</h2>
            <p>Dans le prise des décisions éfficaces</p>
            <a href="contact" class="btn-get-started">Prendre rendez-vous</a>
          </div>
        </div><!-- End Carousel Item -->
    ...
    <section id="services" class="services section">
      ...
      <div class="container">
        <div class="container section-title" data-aos="fade-up">
            <h2>Nos Services</h2>
            <p>Nous fournissons des services spécialisés en matière d’audit de comptabilité et de conseil aux particuliers et aux petites entreprises.</p>
          </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item  position-relative">
              ...
              <a href="#" class="stretched-link">
                <h3 class="text-center">FISCALITE</h3>
              </a>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <a href="#" class="stretched-link">
                <h3 class="text-center">COMPTABILITE</h3>
              </a>
              <p>Nous allons créer et maintenir un plan comptable pour saisir toutes vos transactions financières, afin de fournir la bonne information pour une gestion efficace de votre entreprise.</p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item position-relative">
              ...
              <a href="#" class="stretched-link">
                <h3 class="text-center">AUDITS</h3>
              </a>
              <p>Pour vous permettre d’harmoniser les procédures, les flux de données et les méthodes d’écriture comptables afin que les justificatifs de dépenses soient vérifiés au fil du temps.</p>
            </div>
          </div><!-- End Service Item -->
        ...
        <div class="text-center mt-4">
            ...
            <a href="service" class="btn btn-primary px-12 py-2  " style="width: 250px; text-align: center;"  >VOIR PLUS DE SERVICES</a>
          </div>
      </div>
    ...
    <section
    style="
        background-image: url('assets/img/bien.jpeg');
