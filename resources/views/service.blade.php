...
<section id="about" class="about section">
    ...
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <br>
          <h4 class="mt-4 text-justify" style="text-align: justify; font-family: 'Montserrat', sans-serif;" >Nous sommes convaincus qu’avec une expertise comptable étendue et des conseils
