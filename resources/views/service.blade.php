...
<section id="about" class="about section">
    ...
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <br>
          <h4 class="mt-4 text-justify" style="text-align: justify;" >Nous sommes convaincus qu’avec une expertise comptable étendue et des conseils
    ...
    <section id="services" class="services section">
        <div class="container section-title" data-aos="fade-up">
            <h2>NOS SERVICES QUE NOUS VOUS OFFRONS</h2>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="service-item position-relative">
              ...
              <a href="#" class="stretched-link">
                <a href="#" class="stretched-link">
                    <h3 class="text-center">Conseils</h3>
                  </a>
                  <p>Pour vous permettre d’harmoniser les procédures, les flux de données et les méthodes d’écriture comptables afin que les justificatifs de dépenses soient vérifiés au fil du temps.</p>
              <a href="#" class="stretched-link"></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <a href="#" class="stretched-link">
                <a href="#" class="stretched-link">
                    <h3 class="text-center">Informatique</h3>
                  </a>
                  <p>Pour vous permettre d’harmoniser les procédures, les flux de données et les méthodes d’écriture comptables afin que les justificatifs de dépenses soient vérifiés au fil du temps.</p>
              <a href="#" class="stretched-link"></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <a href="#" class="stretched-link">
                <a href="#" class="stretched-link">
                    <h3 class="text-center">Economie</h3>
                  </a>
                  <p>Pour vous permettre d’harmoniser les procédures, les flux de données et les méthodes d’écriture comptables afin que les justificatifs de dépenses soient vérifiés au fil du temps.</p>
              <a href="#" class="stretched-link"></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <a href="#" class="stretched-link">
                <a href="#" class="stretched-link">
                    <h3 class="text-center">Expertise comptable</h3>
                  </a>
                  <p>Pour vous permettre d’harmoniser les procédures, les flux de données et les méthodes d’écriture comptables afin que les justificatifs de dépenses soient vérifiés au fil du temps.</p>
              <a href="#" class="stretched-link"></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <a href="#" class="stretched-link">
                <a href="#" class="stretched-link">
                    <h3 class="text-center">Finances publiques</h3>
                  </a>
                  <p>Pour vous permettre d’harmoniser les procédures, les flux de données et les méthodes d’écriture comptables afin que les justificatifs de dépenses soient vérifiés au fil du temps.</p>
              <a href="#" class="stretched-link"></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <a href="#" class="stretched-link">
                <a href="#" class="stretched-link">
                    <h3 class="text-center">Commissariat aux comptes</h3>
                  </a>
                  <p>Pour vous permettre d’harmoniser les procédures, les flux de données et les méthodes d’écriture comptables afin que les justificatifs de dépenses soient vérifiés au fil du temps.</p>
              <a href="#" class="stretched-link"></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <a href="#" class="stretched-link">
                <a href="#" class="stretched-link">
                    <h3 class="text-center">Ingénierie financière</h3>
                  </a>
                  <p>Pour vous permettre d’harmoniser les procédures, les flux de données et les méthodes d’écriture comptables afin que les justificatifs de dépenses soient vérifiés au fil du temps.</p>
              <a href="#" class="stretched-link"></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <a href="#" class="stretched-link">
                <a href="#" class="stretched-link">
                    <h3 class="text-center">Divers</h3>
                  </a>
                  <p>Pour vous permettre d’harmoniser les procédures, les flux de données et les méthodes d’écriture comptables afin que les justificatifs de dépenses soient vérifiés au fil du temps.</p>
              <a href="#" class="stretched-link"></a>
            </div>
